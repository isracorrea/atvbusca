...
A explicação da modelagem, implementação do código, execução e discussão sobre as limitações do modelo estão disponíveis no seguinte vídeo: https://youtu.be/QpAAwxgc79o?si=Kj-duw6SyITp28x3 
